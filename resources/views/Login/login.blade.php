...
<head>
  <meta charset="UTF-8">
  <title>CodePen - Log in / Sign up </title>
  <link rel="stylesheet" href="{{ url('css/lo_gin.css')}}">
  <script src="{{ url('js/log_in.js')}}" defer></script>
...
<head>
  ...
  <link rel="stylesheet" href="{{ url('css/TheNoisy/lo_gin.css')}}">
  <script src="{{ url('js/TheNoisy/log_in.js')}}" defer></script>
