...
<head>
    ...
    <script src="{{ url('js/jquery-3.5.1.min.js')}}" defer></script>
            ...
            <table id="datatable" class="col text-center align-self-center table table-fluid table-bordered text-white ">
                ...
                @if(count($contacts->toArray()) > 0)
                    ...
                    <tr>
                      ...
                      <td>
                        {{--button for delete --}}
                          <button class="btn rounded-pill btn-outline-danger btn-md delete">
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        table.on('click','.delete',function() {
          ...
          console.log(data);
          $('#deleteForm').attr('action','contactUs/'+data[0]);
